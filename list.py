...
print(f"the sorted nums: {nums} and new_nums: {new_nums}")
...
print("------")
# filter
result_filter = filter(lambda car: car[1] > 100, cars)
print(f"the result_filter: {result_filter} and type: {type(result_filter)}")
new_cars_filter = list(result_filter)
print("new_cars_filter", new_cars_filter)   